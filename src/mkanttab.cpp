  ...
  if(argc!=2)
    {
      ...
      std::cerr<<"Input file: a 4-space-separated-columns file, with the columns of antenna name, WCS84 x, y, and z for each antenna station"<<std::endl;
      return -1;
    }
  
  TableDesc td("ANTENNA",TableDesc::New);
  td.addColumn(ScalarColumnDesc<double>("DISH_DIAMETER","Physical diameter of dish","StandardStMan","StandardStMan"));
  td.addColumn(ScalarColumnDesc<bool>("FLAG_ROW","Flag for this row","StandardStMan","StandardStMan"));
  td.addColumn(ArrayColumnDesc<double>("PHASE_REFERENCE","Beamformer phase reference position","StandardStMan","StandardStMan",1));
  td.addColumn(ScalarColumnDesc<int>("STATION_ID","ID in STATION table","StandardStMan","StandardStMan"));
  td.addColumn(ScalarColumnDesc<String>("MOUNT","Mount type e.g. alt-az, equatorial, etc.","StandardStMan","StandardStMan"));
  td.addColumn(ScalarColumnDesc<String>("NAME","Antenna name","StandardStMan","StandardStMan"));
  td.addColumn(ArrayColumnDesc<double>("OFFSET","Axes offset of mount to FEED REFERENCE point","StandardStMan","StandardStMan",1));
  td.addColumn(ArrayColumnDesc<double>("POSITION","Antenna X,Y,Z phase reference position","StandardStMan","StandardStMan",1));
  td.addColumn(ScalarColumnDesc<String>("STATION","Station (antenna pad) name","StandardStMan","StandardStMan"));
  td.addColumn(ScalarColumnDesc<String>("TYPE","Antenna type (e.g., SPACE-BASED","StandardStMan","StandardStMan"));
